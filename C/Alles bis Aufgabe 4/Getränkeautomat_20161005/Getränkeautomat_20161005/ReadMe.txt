========================================================================
    KONSOLENANWENDUNG: Getränkeautomat_20161005-Projektübersicht
========================================================================

Diese Getränkeautomat_20161005-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Getränkeautomat_20161005-Anwendung besteht.


Getränkeautomat_20161005.vcxproj
...
Getränkeautomat_20161005.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Getränkeautomat_20161005.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
