========================================================================
    KONSOLENANWENDUNG: 20190919-Projektübersicht
========================================================================

Diese 20190919-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre 20190919-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen 20190919.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
