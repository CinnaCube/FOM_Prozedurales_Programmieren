========================================================================
    KONSOLENANWENDUNG: Kreisberechnung_21060919-Projektübersicht
========================================================================

Diese Kreisberechnung_21060919-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Kreisberechnung_21060919-Anwendung besteht.


Kreisberechnung_21060919.vcxproj
...
Kreisberechnung_21060919.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Kreisberechnung_21060919.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
