========================================================================
    KONSOLENANWENDUNG: Klausur_20161005-Projektübersicht
========================================================================

Diese Klausur_20161005-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Klausur_20161005-Anwendung besteht.


Klausur_20161005.vcxproj
...
Klausur_20161005.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Klausur_20161005.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
