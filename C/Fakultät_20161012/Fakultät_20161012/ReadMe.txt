========================================================================
    KONSOLENANWENDUNG: Fakultät_20161012-Projektübersicht
========================================================================

Diese Fakultät_20161012-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Fakultät_20161012-Anwendung besteht.


Fakultät_20161012.vcxproj
...
Fakultät_20161012.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Fakultät_20161012.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
