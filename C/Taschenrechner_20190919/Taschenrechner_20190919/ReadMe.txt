========================================================================
    KONSOLENANWENDUNG: Taschenrechner_20190919-Projektübersicht
========================================================================

Diese Taschenrechner_20190919-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Taschenrechner_20190919-Anwendung besteht.


Taschenrechner_20190919.vcxproj
...
Taschenrechner_20190919.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Taschenrechner_20190919.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
